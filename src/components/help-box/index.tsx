...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Personal App Owner'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Personal App Owner', 'Collaborator', 'Guest'];
  const addOns: string[] = ['notifications', 'file', 'chat'];
  const applicationName = `My Secretary`;
  const tenantName = `Organizer`;
